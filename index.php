...
<head>
    <meta charset="UTF-8">
    <!-- favicon -->
    <link rel="shortcut icon" href="img/tang.png" type="image/x-icon">
    <title>Viahale Logistics 2 </title>
    <!--bootstrap-->
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-left" tyle="color: blue;">
                        <h1><img class="img-fluid mt-3" src="viahale1.png" height="10px" alt="HireSpot" /></h1>
                        <h1 class="text-dark">Fleet and Transportation Operations</h1>
                        <h4 class="text-primary"><h4>
                                <a class="btn btn-outline-primary btn-lg mt-3" data-bs-toggle="modal"
                                    data-bs-target="#" href="./login.php" role="button">Admin</a>
                                <a class="btn btn-outline-primary btn-lg mt-3" data-bs-toggle="modal"
                                    data-bs-target="#" href="./pages/Login.php" role="button">Staff</a>
                                <!-- create from modal -->
                                <!-- userModal -->
    ...
    <div class="container marketing p-3">
        ...
        <div class="row mt-4">
            <div class="col-lg-4" style="text-align: center;">
                <img class="rounded mb-2" src="./img/tang.png" alt="Generic placeholder image" width="140"
                    height="140">
                <h2 class="text-center ">Find Your Job Easier</h2>
                <p class="text-center">At JobHunt, we understand that finding the right job can be a challenging
            ...
            <div class="col-lg-4" style="text-align: center;">
                <img class="rounded mb-2" src="./img/tres.png" alt="Generic placeholder image" width="140"
                    height="140">
            ...
            <div class="col-lg-4" style="text-align: center;">
                <img class="rounded mb-2" src="./img/ina.png" alt="Generic placeholder image" width="140"
                    height="140">
    ...
    <footer class="bg-white p-4 text-muted ">
        <div class="container">
            ...
            <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
                ...
                <!--copyrights-->
                <div class="d-flex">
                    <a class=" " href="#"><img src="logo1.jpg" width="28px" height="16px" 
                            class="mb-2" /></a>
                    <p class="fs-7">&copy; 2025</p>
                </div>
            </div>
        </div>
    </footer>
